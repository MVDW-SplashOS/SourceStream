...
DIR_INPUT = f"{DIR_CURRENT}/input/"
DIR_OUTPUT = f"{DIR_CURRENT}/output/"
DIR_BUILTSCRIPTS = f"{DIR_INPUT}BuildScripts-main/"
...
def main():
    ...
    if len(sys.argv) == 1:
        logger.log.warn(f"Usage: 'python3 {sys.argv[0]} --<argument 1> --[argument 2]'")
        logger.log.print("")
