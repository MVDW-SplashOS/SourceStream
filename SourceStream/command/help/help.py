...
def print_help():
    ...
    logger.log.print(f"Usage: 'python3 {sys.argv[0]} <argument 1> [argument 2]'")
    ...
    help_available_args = [
        ...
        "upstream-upgrade:<edition>:[package]             :  Upgrade selected edition configuration file with latest version from LFS documentation."
